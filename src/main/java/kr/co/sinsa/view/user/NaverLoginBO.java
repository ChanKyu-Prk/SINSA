...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "DoGnZqM7T0geDjX0udRa";
	private final static String CLIENT_SECRET = "KCHf5HYu7N";
	private final static String REDIRECT_URI = "http://www.sinsa.link/callBack";
