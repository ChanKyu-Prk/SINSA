	...
	<div>
		...
		<form:form method="post" action="prdInsert" modelAttribute="prdVO"
				...
				<table class="imgTable">
					...
					<tr>
						<td class="imgtd"><div class="img_td_row">
								<img class="reviewPic" alt="리뷰 사진" title="리뷰 사진" id="reviewPic0"
									src="/resources/img/default.png" />

							</div></td>
						<td class="imgtd"><div class="img_td_row">
								<img class="reviewPic" alt="리뷰 사진" title="리뷰 사진" id="reviewPic1"
									src="/resources/img/default.png" />

							</div></td>
						<td class="imgtd"><div class="img_td_row">
								<img class="reviewPic" alt="리뷰 사진" title="리뷰 사진" id="reviewPic2"
									src="/resources/img/default.png" />

							</div></td>
						<td class="imgtd"><div class="img_td_row">
								<img class="reviewPic" alt="리뷰 사진" title="리뷰 사진" id="reviewPic3"
									src="/resources/img/default.png" />

							</div></td>
						<td class="imgtd"><div class="img_td_row">
								<img class="reviewPic" alt="리뷰 사진" title="리뷰 사진" id="reviewPic4"
									src="/resources/img/default.png" />
			...
			<table>
				...
				<tr>
					<td>구분 :</td>
					<td><form:select path="prd_gender">
				...
				<tr>
					<td>상품설명 :</td>
					<td><form:textarea path="prd_detail" cols="50" rows="5" /></td>
				</tr>
				<tr>
